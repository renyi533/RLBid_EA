...
def init_parser():
    ...
    parser.add_argument('--model_name', default='USCB')
    ...
    parser.add_argument('--save_log_dir', default='../uscb/log/')
    ...
    parser.add_argument('--lamda', type=float, default=4.0)
    parser.add_argument('--beta', type=float, default=1.0)
    parser.add_argument('--tCPC', type=float, default=30000.0)
